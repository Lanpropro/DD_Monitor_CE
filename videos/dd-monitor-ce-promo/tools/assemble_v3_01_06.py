"""Join scenes 01–06 with the recorded-audio section and continuous music."""
...
OUTPUT = RENDERS / "v3-01-06-preview.mp4"
...
def main():
    ...
    filters += [
        ...
        f"[v01234][v5]xfade=transition=fadewhite:duration=0.55:offset={SIXTH_JOIN}[vout]",
        f"[6:a]atrim=0:{FINAL_LENGTH},asetpts=PTS-STARTPTS,"
