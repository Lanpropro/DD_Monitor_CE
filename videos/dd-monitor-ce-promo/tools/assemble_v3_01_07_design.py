"""Join 01–05, the revised scene 06 design preview, and the 07 logo ending."""
...
def live_gain():
    ...
    levels = [
        (1.40, "0"),
        (2.00, "2.6*(t-1.40)/0.60"),
        (8.15, "2.6"),
        (8.60, "2.6*(8.60-t)/0.45"),
        (11.05, "0"),
        (11.65, "2.6*(t-11.05)/0.60"),
        (14.85, "2.6"),
        (15.30, "2.6*(15.30-t)/0.45"),
    ]
    expression = "0"
    for time, level in reversed(levels):
        expression = f"if(lt(t,{time}),{level},{expression})"
