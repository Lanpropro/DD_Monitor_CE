"""Verify that the 01–04 preview retains music gaps and simultaneous stereo sound."""
...
VIDEO = PROJECT / "renders" / "v3-01-04-preview.mp4"
...
def main():
    ...
    assert abs(float(info["format"]["duration"]) - 41.55) < 0.04
    ...
    print("v3 01-04: transitions, music gaps, and simultaneous stereo audio verified")
