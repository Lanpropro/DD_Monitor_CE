...
typography:
  ...
  # — display / hero ramp (Microsoft YaHei UI 400, negative tracking) —
  table-name:  { fontFamily: "Microsoft YaHei UI", cqw: 1.5, weight: 400, lineHeight: 1.15 }
  row-headline:{ fontFamily: "Microsoft YaHei UI", cqw: 2.1, weight: 400, lineHeight: 1.05 }
  ed-callout:  { fontFamily: "Microsoft YaHei UI", cqw: 2.6, weight: 400, lineHeight: 1.1, italic: true }
  headline:    { fontFamily: "Microsoft YaHei UI", cqw: 4.6, weight: 400, lineHeight: 0.95 }
  headline-index:{ fontFamily: "Microsoft YaHei UI", cqw: 5.0, weight: 400, lineHeight: 0.95 }
  display-quote:{ fontFamily: "Microsoft YaHei UI", cqw: 5.7, weight: 400, lineHeight: 1.05, tracking: "-0.005em" }
  display-chapter:{ fontFamily: "Microsoft YaHei UI", cqw: 6.8, weight: 400, lineHeight: 1.0, tracking: "-0.005em" }
  display-closing:{ fontFamily: "Microsoft YaHei UI", cqw: 9.4, weight: 400, lineHeight: 0.96, tracking: "-0.005em" }
  display-hero:{ fontFamily: "Microsoft YaHei UI", cqw: 10.4, weight: 400, lineHeight: 0.9, tracking: "-0.008em" }
  vbig-numeral:{ fontFamily: "Microsoft YaHei UI", cqw: 12.5, weight: 400, lineHeight: 0.9, tracking: "-0.015em" }
